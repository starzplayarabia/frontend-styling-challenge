...
export const DropdownStyled = styled.div`
  ...
  background-color: ${props => props.isOpened && props.theme.components.dropdown.background.opened};
...
export const IconArrowStyled = styled(Icon)`
  ...
  display: inline-block;
  ${props => `margin-${props.theme.locale.dir === "rtl" ? "right" : "left"}: ${props.theme.spacing.small};`}
...
export const OptionsStyled = styled.ul`
  position: absolute;
  background-color: ${props => props.theme.components.dropdown.options.backgroundColor};
  padding: ${props => props.theme.spacing.default} 0;
  /* TODO: Add z-index values to the theme 
  ...
  */
  ...
  /* Media queries */
  ${media.medium`
    border-radius: ${props => props.theme.components.dropdown.options.border.radius};
    left:  ${props => props.optionsPosition === "center" 
      ? "50%" 
      :  props.optionsPosition === "left" 
        ? "0"
        : "initial"
    };
    right:  ${props => props.optionsPosition === "center" 
      ? "initial" 
      :  props.optionsPosition === "left" 
        ? "initial"
        : "0"
    };
    transform: ${props => props.optionsPosition === "center" && `translate(-50%)`};
  `}
`;
...
export const OptionStyled = styled.li`
  ...
  font-weight: ${props => (props.isSelected ? props.theme.font.weight.bold : props.theme.font.weight.light)};
  color: ${props => props.theme.components.dropdown.option.font.color || props.theme.color.primary};
