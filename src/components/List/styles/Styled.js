...
export const UlStyled = styled.ul`
  ...
  color: ${props => props.theme.color[props.color] || props.color || props.theme.color.primary};
...
export const LiStyled = styled.li`
  ...
  & + & {
    ${props => `margin-${props.theme.locale.dir === "rtl" ? "right" : "left"}: 0.5em`};
  }
  &:not(:last-child) {
    &::after {
      content: "";
      ...
      width: 1px;
      height: 1.3em;
      background-color: ${props => props.theme.components.detail.info.color || props.theme.color.primaryBlack};
...
export const DtStyled = styled.dt`
  ...
  ${props =>
    props.display === "inline" &&
    `
    margin-${props.theme.locale.dir === "rtl" ? "left" : "right"}: ${props.theme.spacing.default};
...
export const DdStyled = styled.dd`
  margin-bottom: ${props => (props.display === "inline" ? props.theme.spacing.default : props.theme.spacing.small)};
  ${props =>
    props.display === "inline" &&
    `
    max-width: 80%;
